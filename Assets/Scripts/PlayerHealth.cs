...
public class PlayerHealth : LivingEntity {
    ...
    private PlayerLookAtMouse palyerLookAtMouse; // 플레이어 fov
    ...
    private void Awake() {
        ...
        palyerLookAtMouse = GetComponent<PlayerLookAtMouse>();
    ...
    protected override void OnEnable() {
        ...
        palyerLookAtMouse.enabled = true;
    ...
    public override void Die() {
        ...
        palyerLookAtMouse.enabled = false;
